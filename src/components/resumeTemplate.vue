<template>
    <div>
        <div id="resumeimg">
            <img id="rimg" :src="resumeimgurl">
        </div>
        <button @click="generateImg">click</button>
        <div id="container">
            <div id="sidebar">
    ...
    export default{
        ...
        methods:{
            generateImg(){
                ...
                var self = this, rimg = document.getElementById('rimg');
...
//                    console.log(canvas.getContext('2d').getImageData(0,0, 100, 100));
//
                    self.resumeimgurl = canvas.toDataURL('image/jpeg', 1.0);
//
//                        resumeHidden.appendChild(canvas);
                    //var ownCanvas = document.querySelector('#resumehidden canvas');
                })
            }
        }
    }
